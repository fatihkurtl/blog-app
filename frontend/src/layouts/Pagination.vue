...
<template>
    <div class="col-span-2 md:col-span-3 sm:mt-2 my-4">
    ...
    <!-- <div class="col-span-2 md:col-span-3 sm:mt-2">
        <div class="flex items-center justify-center"> -->
    <!-- Previous Button -->
    <!-- <a href="#"
                class="flex items-center justify-center px-4 h-10 mr-3 text-base font-medium text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-darkItemsColor dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:hover:text-white">
    ...
    <!-- Next Button -->
    <!-- <a href="#"
                class="flex items-center justify-center px-4 h-10 text-base font-medium text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-darkItemsColor dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:hover:text-white">
                Next
