                        ...
                        <div>
                            ...
                            <div class="mt-4">
                                <div class="flex items-center h-5">
                                    <input id="show-email" aria-describedby="show-email" name="show-email" type="checkbox"
                                    ...
                                    <label for="show-email" class="ml-2 font-sans text-gray-500 dark:text-gray-400">
                                        {{ $t('display-email') }}
                                    </label>
                                </div>
                            </div>
